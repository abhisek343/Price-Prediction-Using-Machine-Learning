...
Print-Message "激活虚拟环境 (Activating virtual environment)..."
try {
    .\venv\Scripts\Activate.ps1
} catch {
    Print-Message "⚠️ Activation might require setting execution policy. If script fails, try:" -Color Yellow
...
Print-Message "ℹ️  Press CTRL+C in this terminal to stop the UI." -Color Yellow

# Start Flask app. It will take over this terminal.
python ui/app.py

Print-Message "👋 Flask UI process ended."
